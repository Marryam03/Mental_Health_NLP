...
We therefore added a regression head with a single output neuron and trained it with MSE loss on the continuous 1--10 scale, keeping all other settings unchanged. Validation MSE improved from $3.637$ to $2.758$ by epoch 3 and then plateaued; the trainer automatically restored this checkpoint. On the test set, the regression model achieved an exact-match accuracy of $45.28\%$, an off-by-one accuracy of $86.60\%$, a 5-bucket accuracy of $75.66\%$, a QWK of $0.9387$, a mean absolute error of $0.8061$, and a weighted F1 of $0.4828$. These results show that the regression formulation produced strong ordinal alignment, with a QWK close to that of RoBERTa-base, even though its exact accuracy remained below the best classification runs from DeBERTa-Large and RoBERTa-base.
...
\midrule
Exact accuracy (10-class) $\uparrow$ & 0.5443 & \textbf{0.6372} & 0.4528 \\
Off-by-one accuracy $\uparrow$       & 0.8581 & \textbf{0.8946} & 0.8660 \\
5-bucket accuracy $\uparrow$         & 0.7859 & \textbf{0.8306} & 0.7566 \\
QWK $\uparrow$                       & 0.9333 & \textbf{0.9504} & 0.9387 \\
F1 weighted $\uparrow$               & 0.5696 & \textbf{0.6545} & 0.4828 \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
BEST            & 0.715          & \textbf{0.753} & 0.687 \\
VERY\_GOOD      & 0.326          & \textbf{0.450} & 0.313 \\
GOOD            & 0.282          & \textbf{0.349} & 0.197 \\
MODERATE\_GOOD  & 0.531          & \textbf{0.638} & 0.488 \\
NEUTRAL         & 0.418          & \textbf{0.434} & 0.267 \\
MODERATE\_BAD   & 0.522          & \textbf{0.614} & 0.369 \\
BAD             & \textbf{0.372} & 0.345          & 0.197 \\
VERY\_BAD       & 0.272          & \textbf{0.356} & 0.219 \\
VERY\_VERY\_BAD & 0.682          & \textbf{0.800} & 0.538 \\
WORST           & 0.521          & \textbf{0.630} & 0.439 \\
\midrule
Weighted avg    & 0.570          & \textbf{0.654} & 0.483 \\
\bottomrule
\end{tabular}}
\end{table}
...
\midrule
Healthy  & 0.822 & \textbf{0.874} & 0.815 \\
Good     & 0.630 & \textbf{0.720} & 0.595 \\
Neutral  & 0.418 & \textbf{0.434} & 0.267 \\
Bad      & 0.712 & \textbf{0.761} & 0.667 \\
Critical & 0.920 & \textbf{0.920} & 0.892 \\
\midrule
Weighted avg & 0.793 & \textbf{0.835} & 0.768 \\
\bottomrule
\end{tabular}
\end{table}
